...
public class InspirationService {
    ...
    public List < Inspiration > getAllInspirations( ) {
        return List.of(
                ...
                new Inspiration("Louis Vuitton" , "Capucines Bag" , "High-end designer taske i premium kvalitet" , 42000 , "/images/lvbag.jpg" , "Fashion") ,
                new Inspiration("Hermès" , "Birkin Bag" , "Verdens mest eksklusive taske med ekstrem efterspørgsel" , 120000 , "/images/birkin.jpg" , "Fashion") ,
                new Inspiration("Tesla" , "Model 3" , "Elektrisk bil med høj performance og moderne teknologi" , 350000 , "/images/tesla.jpg" , "Tech") ,

                new Inspiration("Bang & Olufsen" , "Beolab 28" , "High-end højtalersystem i luksusklassen" , 110000 , "/images/bo.jpg" , "Tech") ,
                ...
                new Inspiration("Vitra" , "Eames Lounge Chair" , "Ikonisk designerstol i luksussegmentet" , 55000 , "/images/chair.jpg" , "Lifestyle") ,
